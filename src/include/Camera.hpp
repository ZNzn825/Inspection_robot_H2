...
namespace sl {
    ...
    public:
        ...
        */
        ...
        \param other The sl::String to compare with the current sl::String.
    ...
    \ingroup Core_group
    \brief Lists available serialization format
     */
    enum class SERIALIZATION_FORMAT {
        LEGACY, // OpenCV filestorage
        JSON, // JSON
        AUTO // Based on filename extension (fallback to SERIALIZATION_FORMAT::LEGACY)
    };

    // return true if success
    bool /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ saveJSONFile(const sl::String filepath, const sl::String &serialized_content, bool merge = false);
    ...
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ Resolution {
        ...
        */
        ...
        \param format: serialization format, default is JSON
    ...
    \enum CAMERA_TYPE
    \ingroup Video_group
    \brief Lists available camera types.
     */
    enum class CAMERA_TYPE {
        MONO, /**< Monocular camera*/
        STEREO, /**< Stereoscopic camera*/
        ///@cond SHOWHIDDEN
        LAST
        ///@endcond
    };
    ...
    ///@cond SHOWHIDDEN
    String SL_CORE_EXPORT toString(const CAMERA_TYPE &camera_type);

    inline std::ostream &operator<<(std::ostream &os, const CAMERA_TYPE &camera_type) {
        return os << toString(camera_type);
    }
    ...
    private:
        ...
        sl::String configuration = "0", raw_configuration;
        bool init_ = false;
    };
...
#undef GPU
    ...
    public:
        ...
        \note This method is templated for \ref sl::uchar1, \ref sl::uchar2, \ref sl::uchar3, \ref sl::uchar4, \ref sl::float1, \ref sl::float2, \ref sl::float3, \ref sl::float4, \ref sl::char4, \ref sl::ushort1.
         */
        template <typename T>
   ...
   \brief Class containing the results of the body tracking module.
    ...
    public:
        ...
        /**
         * @brief Comparison operator ==
         * @param CommunicationParameters to compare
         * @return true if the two struct are identical
         */
   ...
   That information can be retrieved by sl::Camera::getHealthStatus(), and enabled by sl::InitParameters::enable_image_validity_check 
    ...
    struct /*@cond SHOWHIDDEN*/ SL_CORE_EXPORT /*@endcond*/ HealthStatus {
        ...
        bool corrupted_image = false; // Generally due to Camera issue, like stuck ISP (black/white/green/purple images, incorrect exposure, etc)
        ...
        bool unreliable_sensors = false; // Generally due to IMU giving incorrect value, caused by heavy vibration or other external perturbations

        // enable_image_validity_check >= 2
        // If one of the following output true for several seconds, this means an intervention is probably required to clean the lens or reposition the camera
        bool degraded_images = false; // Partially occluded images, blurry images, left and right images too different. The camera can still be used but the measure are less reliable
        bool unreliable_depth = false; // Typically due to obstructed eye (included very close object, strong occlusions) or degraded condition like heavy fog/water on the optics

        // enable_image_validity_check >= 3
        bool blurry_images = false; // Check specifically for blurry image (this diagnostic is disabled by default)

        // enable_image_validity_check >= 4 : includes more image check on the difference between left and right        
    };
}
#endif /* __CORE_HPP__ */
#ifndef __MESH_HPP__
...
#define ZED_SDK_PATCH_VERSION 5

#define ZED_SDK_BUILD_ID "97569_fda16971"
...
#define isValidMeasure(v) (std::isfinite(v))
    ...
    bool /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ fromString(const sl::String &svo_compression_str, SVO_COMPRESSION_MODE &svo_compression);
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ RecordingStatus {
        ...
        */
        ...
        /**
        \brief Number of frames effectively encoded and written. Might be different from the number of frames ingested. The difference will show the encoder latency
        */
...
namespace sl {
    ...
    public:
        ...
        /**
         * @brief If set to true will camera image retrieve at a framerate different from \ref grab() application framerate.
    ...
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ObjectDetectionParameters {
        ...
        \attention - The caching uses the deserialized `custom_onnx_file` along with your GPU specs to decide whether to use the cached optmized model or to optimize the passed onnx model.
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ CustomObjectDetectionProperties {
        /**
    ...
    \note Parameters can be adjusted by the user.
     */
    struct /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ CustomObjectDetectionRuntimeParameters {
        /**
    ...
    public:
        ...
        \warning Using this function is not a standard behavior as it creates a jump in time, backward or forward (which can not happen in live conditions). 
        This function will then reset many modules such as positional tracking or spatial mapping.
        ...
        /// @copydoc sl::Camera::retrieveObjects(sl::Objects&, sl::ObjectDetectionRuntimeParameters, const unsigned int)
        ERROR_CODE retrieveObjects(Objects &objects, CustomObjectDetectionRuntimeParameters parameters, const unsigned int instance_id = 0);
    ...
    bool /*@cond SHOWHIDDEN*/SL_SDK_EXPORT/*@endcond*/ fromString(const sl::String &map_type_str, SpatialMappingParameters::SPATIAL_MAP_TYPE& map_type);
